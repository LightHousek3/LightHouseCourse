...
<html lang="en">
    ...
    <head>
        <title>Add Customer - LightHouse Admin</title>
    ...
    <body>
                ...
                <div class="container-fluid">
                    ...
                    <div class="admin-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-none d-lg-block">
                            <h2 class="m-0"><i class="fas fa-user-plus"></i> Add New Customer</h2>
                            <div>
                        ...
                        <div class="header-actions">
                            <a href="${pageContext.request.contextPath}/admin/customers" class="btn btn-lg btn-primary">
                        ...
                        <div class="card-body">
                            <form action="${pageContext.request.contextPath}/admin/customers" method="post"
                                ...
                                <div class="form-section">
                                    <h3 class="section-title"><i class="fas fa-user-shield me-2"></i> Account
                                        Information</h3>
                                    <div class="row g-3">
                                        <div class="col-md-6">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 mx-auto">
                                            <div class="avatar-section">
                                                <c:choose>
                                                    <c:when test="${not empty avatarUrl && avatarUrl != '/assets/imgs/avatars/default-user.png' && avatarUrl.startsWith('data:image')}">
                                                        <img src="${avatarUrl}" alt="Customer Avatar" class="avatar-preview" id="avatarPreview">
                                                    </c:when>
                                                    <c:otherwise>
                                                ...
                                                <div>
                                                    ...
                                                    <input type="hidden" id="avatarUrl" name="avatarUrl" value="${not empty avatarUrl ? avatarUrl : '/assets/imgs/avatars/default-user.png'}">
                                                </div>
        ...
        <script>
            ...
            // Avatar image preview with existing data retention
