    ...
    <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
        ...
        <div class="admin-sidebar">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link ${activeMenu eq 'superusers' ? 'active' : ''}"
                        href="${pageContext.request.contextPath}/admin/superusers">
                        <i class="fa-solid fa-users-gear"></i> Manage Super Users
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link ${activeMenu eq 'customers' ? 'active' : ''}"
