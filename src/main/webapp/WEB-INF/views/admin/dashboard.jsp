                                            ...
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div>
                                                        ...
                                                        <h2 class="mb-0">${recentRefundRequests.size()}</h2>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="${pageContext.request.contextPath}/admin/refunds"
                                                    class="btn btn-warning btn-sm">View All Refunds</a>
                                            </div>
                                            <div class="card-body">
                                        ...
                                        <div class="card">
                                            <div class="card-header d-flex justify-content-between align-items-center">
                                                ...
                                                <a href="${pageContext.request.contextPath}/admin/course/pending"
                                                    class="btn btn-warning btn-sm">View All Pending</a>
                                            </div>
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table table-hover align-middle">
