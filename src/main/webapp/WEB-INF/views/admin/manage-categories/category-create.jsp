    ...
    <body>
        ...
        <div class="admin-content">
            ...
            <div class="admin-header d-flex justify-content-between align-items-center">
                ...
                <h2 class="m-0 d-none d-lg-block">Add New Category</h2>
                <a href="${pageContext.request.contextPath}/admin/categories" class="btn btn-lg btn-primary">
            ...
            <div class="mt-4 form-container">
                ...
                <c:if test="${not empty param.error}">
                    <div class="alert alert-danger alert-dismissible fade show" role="alert">
                        ...
                        <c:choose>
                            ...
                            <c:when test="${param.error eq 'add_failed'}">Category add failed, please try again.</c:when>
                ...
                <c:if test="${not empty param.success}">
                    <div class="alert alert-success alert-dismissible fade show" role="alert">
                        ...
                        <c:choose>
                            <c:when test="${param.success eq 'added'}">Category added successfully!</c:when>
                                ...
                                <div class="col-md-12">
                                    <div class="mb-4">
                                        ...
                                        <textarea class="form-control ${param.error eq 'missing_fields' or param.error eq 'description_too_long' ? 'error-field' : ''}" 
                                                  ...
                                                  maxlength="150">${param.description}</textarea>
                                        <div class="d-flex justify-content-between align-items-center mt-1">
                                            <div class="form-text">
                                                <i class="fas fa-info-circle me-1"></i>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="d-flex justify-content-end gap-3">
                                        <a href="${pageContext.request.contextPath}/admin/categories" class="btn btn-md btn-secondary">
        ...
        <script>
            ...
            // Real-time duplicate check (optional - requires AJAX)
            ...
            document.getElementById('categoryName').addEventListener('input', function () {
                ...
                // Check for duplicate after user stops typing (500ms delay)
                if (name.length > 0) {
            ...
            // Function to check duplicate name via AJAX (optional)
            function checkDuplicateName(name) {
                // Implementation for AJAX duplicate check if needed
            }
