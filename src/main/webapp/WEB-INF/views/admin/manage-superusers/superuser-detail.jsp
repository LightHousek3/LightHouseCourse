                                            ...
                                            <div class="profile-section">
                                                ...
                                                <ul class="info-list">
                                                    <li>
                                                        ...
                                                        <span class="info-value">${not empty instructor.specialization ?
                                                            instructor.specialization : 'Not specified'}</span>
                                                    </li>
                                                    <li>
                                                        <i class="fas fa-book-open"></i>
                                                        <span class="info-label">Biography:</span>
                                                        <span class="info-value">
                                                            ${not empty instructor.biography ? instructor.biography :
