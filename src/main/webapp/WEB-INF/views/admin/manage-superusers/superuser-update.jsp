                                                        ...
                                                        <div class="avatar-section">
                                                            ...
                                                            <div>
                                                                ...
                                                                <input type="hidden" id="avatarUrl" name="avatarUrl"
                                                                    value="${not empty avatarUrl ? avatarUrl : (not empty selectedUser.avatar ? selectedUser.avatar : pageContext.request.contextPath.concat('/assets/imgs/avatars/default-admin.png'))}">
                                                            </div>
