<%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8" %>
    <%@ taglib prefix="c" uri="http://java.sun.com/jsp/jstl/core" %>
        <%@ taglib prefix="fmt" uri="http://java.sun.com/jsp/jstl/fmt" %>
            ...
            <head>
                <title>Add Super User - LightHouse Admin</title>
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="admin-header d-flex justify-content-between align-items-center">
                                ...
                                <div class="d-none d-lg-block">
                                    <h2 class="m-0"><i class="fas fa-user-plus"></i> Add Super User</h2>
                                    <div>
                                        <nav aria-label="breadcrumb" class="breadcrumb-nav">
                                            <ol class="breadcrumb">
                                                ...
                                                <li class="breadcrumb-item active" aria-current="page">Add Super User
                                                </li>
                                            </ol>
                                        </nav>
                                    </div>
                                    ...
                                    <form action="${pageContext.request.contextPath}/admin/superusers" method="post"
                                        ...
                                        <div class="form-section">
                                            ...
                                            <div class="role-selector">
                                                <div class="role-card ${role == null || role == 'admin' ? 'selected' : ''}"
                                                    data-role="admin">
                                                    <div class="role-icon">
                                                        <i class="fas fa-user-shield"></i>
                                                    </div>
                                                    <div class="role-title">Admin</div>
                                                    <div class="role-description">Can manage all aspects of the system
                                                    </div>
                                                </div>
                                                <div class="role-card ${role == 'instructor' ? 'selected' : ''}"
                                                    data-role="instructor">
                                                    <div class="role-icon">
                                                        <i class="fas fa-chalkboard-teacher"></i>
                                                    </div>
                                                    <div class="role-title">Instructor</div>
                                                    <div class="role-description">Can create and manage courses</div>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-section instructor-fields" id="instructorFields"
                                            style="display: ${role == 'instructor' ? 'block' : 'none'}">
                                            ...
                                            <div class="row">
                                                <div class="col-md-12 mx-auto">
                                                    <div class="avatar-section">
                                                        <c:choose>
                                                            <c:when test="${not empty avatarUrl && avatarUrl.startsWith('data:image')}">
                                                                <img src="${avatarUrl}" alt="User Avatar" class="avatar-preview" id="avatarPreview">
                                                                <input type="hidden" id="avatarPlaceholderInput" name="avatar" value="${avatarUrl}" />
                                                            </c:when>
                                                            <c:otherwise>
                                                                <input type="hidden" id="avatarPlaceholderInput" name="avatar"
                                                                    value="${avatar != null ? avatar : pageContext.request.contextPath.concat('/assets/imgs/avatars/default-admin.png')}" />

                                                                <img class="avatar-placeholder" id="avatarPlaceholder"
                                                                    src="${avatar != null ? avatar : pageContext.request.contextPath.concat('/assets/imgs/avatars/default-admin.png')}"
                                                                    alt="Avatar" />
                                                            </c:otherwise>
                                                        </c:choose>
                                                        <div>
                                                            <div>
                                                                ...
                                                                <input type="hidden" id="avatarUrl" name="avatarUrl"
                                                                    value="${not empty avatarUrl ? avatarUrl : (avatar != null ? avatar : pageContext.request.contextPath.concat('/assets/imgs/avatars/default-admin.png'))}">
                                                            </div>
                        ...
                        document.getElementById('avatarInput').addEventListener('change', function (e) {
                            ...
                            if (file) {
                                ...
                                reader.onload = function (e) {
                                    ...
                                    const placeholderInput = document.getElementById('avatarPlaceholderInput');
                                    ...
                                    if (placeholderInput) {
                                        placeholderInput.value = e.target.result;
                                    }
