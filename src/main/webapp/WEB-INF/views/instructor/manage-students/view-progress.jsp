            ...
            <div class="card-body">
                <div class="student-info d-flex flex-wrap">
                    ...
                    <div class="flex-grow-1">
                        ...
                        <p class="mb-1"><i class="fas fa-envelope me-2"></i>${student.email}</p>
                        <p class="mb-1"><i class="fas fa-phone me-2"></i>${student.phone}</p>
                    ...
                    <div class="ms-auto text-end">
                        ...
                        <div class="d-flex flex-column align-items-end">
                            <div class="mb-2 d-flex align-items-center">
                                <span class="me-2">Overall Progress:</span>
                            ...
                            <div class="mt-2">
                                <small class="text-muted">Last accessed: 
                                    <fmt:formatDate value="${courseProgress.lastAccessDate}" pattern="dd/MM/yyyy HH:mm" />
                                </small>
                            </div>
                        </div>
                    </div>
