        ...
        <div class="instructor-content">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/instructor/students">Students</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Progress Details</li>
                </ol>
            </nav>
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12 col-lg-8">
                            <div class="d-flex flex-column flex-sm-row align-items-start">
                                ...
                                <div class="flex-grow-1">
                                    ...
                                    <button class="btn btn-info btn-sm w-auto" 
                        ...
                        <div class="col-12 col-lg-4">
                            <div class="h-100 d-flex flex-column justify-content-center">
                                <!-- Course Name -->
                                <h5 class="text-primary mb-3 text-center text-lg-end">${course.name}</h5>

                                <!-- Progress Section -->
                                <div class="text-center text-lg-end">
                                    <!-- Progress Label and Percentage -->
                                    <div class="d-flex justify-content-between justify-content-lg-end align-items-center mb-2">
                                        <span class="fw-semibold">Overall Progress:</span>
                                        <span class="fw-bold text-primary ms-2">${courseProgress.completionPercentage}%</span>
                                    </div>
                                    ...
                                    <!-- Status Badge -->
                                    <div class="mb-2">
                                        <span class="badge ${courseProgress.isCompleted ? 'bg-success' : 'bg-warning'}">
                                    ...
                                    <div>
                                        <small class="text-muted">
                                            Last accessed: <fmt:formatDate value="${courseProgress.lastAccessDate}" pattern="dd/MM/yyyy HH:mm" />
                                        </small>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="lesson-card card">
                                <div class="lesson-header card-header d-flex justify-content-between align-items-center" 
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="progress me-2" style="width: 100px;">
                                            ...
                                            <c:if test="${lessonData.progress != null}">
                                                ...
                                                <c:if test="${not empty lessonData.items}">
                                                    <c:set var="lessonProgress" value="${(completedItems / lessonData.items.size()) * 100}" />
                                                </c:if>
                                            </c:if>
                                        ...
                                        <span><fmt:formatNumber value="${lessonProgress}" maxFractionDigits="0" />%</span>
                                        <span class="ms-3"><i class="fas fa-chevron-down"></i></span>
                                    </div>
                                </div>
                                <div id="lesson${lessonData.lesson.lessonID}" class="collapse" data-bs-parent="#lessonsAccordion">
                                    <div class="lesson-items card-body">
                                        <c:forEach items="${lessonData.items}" var="itemData" varStatus="itemStatus">
                                            <div class="item-row d-flex justify-content-between align-items-center">
                                                <div>
                                                    <span class="item-icon">
                                                        <c:choose>
                                                            <c:when test="${itemData.item.itemType eq 'video'}">
                                                                <i class="fas fa-video"></i>
                                                            </c:when>
                                                            <c:when test="${itemData.item.itemType eq 'quiz'}">
                                                                <i class="fas fa-question-circle"></i>
                                                            </c:when>
                                                            <c:when test="${itemData.item.itemType eq 'material'}">
                                                ...
                                                <div>
                                                    <c:choose>
                                                        <c:when test="${itemData.progress.isCompleted}">
                                                            ...
                                                            <c:if test="${not empty itemData.progress.completionDate}">
                                                                <small class="text-muted ms-2">
                                                                    (<fmt:formatDate value="${itemData.progress.completionDate}" pattern="dd/MM/yyyy" />)
                                                                </small>
                                                            </c:if>
                                                        </c:when>
                                                        <c:when test="${not empty itemData.progress}">
                                                            ...
                                                            <small class="text-muted ms-2">
                                                                Last accessed: <fmt:formatDate value="${itemData.progress.lastAccessDate}" pattern="dd/MM/yyyy" />
                                                            </small>
                                                        </c:when>
                                                        <c:otherwise>
                    ...
                    <div class="modal-content">
                        ...
                        <form action="${pageContext.request.contextPath}/instructor/students" method="post">
                            <div class="modal-body">
                                ...
                                <input type="hidden" name="studentId" id="modalStudentId" value="${student.customerID}">

                                <div class="mb-3">
                                    <label for="studentName" class="form-label">Student Name</label>
                                    <input type="text" class="form-control" id="modalStudentName" value="${student.fullName}" readonly>
                                </div>

                                <div class="mb-3">
                                    <label for="studentEmail" class="form-label">Student Email</label>
                                    <input type="email" class="form-control" id="modalStudentEmail" value="${student.email}" readonly>
                                </div>

                                <div class="mb-3">
                                    <label for="subject" class="form-label">Subject</label>
                                    <input type="text" class="form-control" id="subject" name="subject" required
                                           value="Regarding your progress in ${course.name}">
                                </div>
