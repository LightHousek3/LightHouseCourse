        ...
        <script>
            ...
            function loadPurchaseChart() {
                const url = currentState.purchaseView === 'yearly'
                        ? '${pageContext.request.contextPath}/instructor/statistics/purchase?year=' + currentState.year
                        : '${pageContext.request.contextPath}/instructor/statistics/purchase/monthly?year=' + currentState.year;
            ...
            function loadRatingChart() {
                const url = currentState.ratingView === 'yearly'
                        ? '${pageContext.request.contextPath}/instructor/statistics/rating?year=' + currentState.year
                        : '${pageContext.request.contextPath}/instructor/statistics/rating/monthly?year=' + currentState.year;
