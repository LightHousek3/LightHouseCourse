                ...
                <body>
                    <div class="quiz-container">
                                ...
                                <div class="quiz-meta">
                                    ...
                                    <c:if test="${quiz.timeLimit != null}">
                                        <div class="quiz-meta-item">
                                            ...
                                            <span>
                                                <fmt:formatNumber value="${Math.floor(quiz.timeLimit / 60)}"
                                                    pattern="#" />
                                                minutes time limit
                                            </span>
                                        </div>
                        ...
                        <div class="modal fade" id="submitQuizModal" tabindex="-1"
                            aria-labelledby="submitQuizModalLabel" aria-hidden="true">
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <div class="modal-header text-white">
                                        <h5 class="modal-title" id="submitQuizModalLabel">Confirm Submission</h5>
                                        <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                                            aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body">
                                        <p id="submitQuizMessage">Are you sure you want to submit the quiz? This cannot
                                            be undone.</p>
                                    </div>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
                                            data-bs-dismiss="modal">Cancel</button>
                                        <button type="button" class="btn btn-primary" id="confirmSubmitBtn">Submit
                                            Quiz</button>
                                    </div>
                                </div>
                            </div>
                    ...
                    <script>
                        ...
                        // Function to show the submit quiz modal
                        function showSubmitQuizModal(action = 'normal') {
                            const totalAnswered = Object.keys(userAnswers).length;
                            const submitQuizMessage = document.getElementById('submitQuizMessage');
                            ...
                            if (action === 'timeOut') {
                                // Time out - just submit without confirmation
                                processQuizSubmission();
                                return;
                            } else if (totalAnswered < quizQuestions.length) {
                                submitQuizMessage.innerHTML = `You have only answered <strong>${totalAnswered} of ${quizQuestions.length}</strong> questions. Are you sure you want to submit?`;
                            } else {
                                submitQuizMessage.innerHTML = 'Are you sure you want to submit the quiz? This cannot be undone.';
                            }
                        ...
                        function startTimer() {
                            ...
                            timerInterval = setInterval(function () {
                                ...
                                if (timeRemaining <= 0) {
                                    clearInterval(timerInterval);
                                    processQuizSubmission(); // Direct submission without confirmation when time is out
                                }
                        ...
                        function setupEventListeners() {
                            ...
                            const submitButton = document.getElementById('submitButton');
                            if (submitButton) {
                                submitButton.addEventListener('click', showSubmitQuizModal);
                            }

                            // Confirm submit button in modal
                            const confirmSubmitBtn = document.getElementById('confirmSubmitBtn');
                            if (confirmSubmitBtn) {
                                confirmSubmitBtn.addEventListener('click', processQuizSubmission);
                            }
