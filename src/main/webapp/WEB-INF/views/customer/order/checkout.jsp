                            ...
                            <div class="card-body">
                                    ...
                                    <div class="d-flex align-items-center cart-item">
                                        ...
                                        <div class="flex-grow-1">
                                            ...
                                            <p class="text-muted mb-0">
                                                ...
                                                <c:forEach var="instructor" items="${course.instructors}" varStatus="loop">
                                ...
                                <c:if test="${not isDirectCheckout}">
                                    <c:forEach var="item" items="${sessionScope.cart.items}" varStatus="status">
                                        <div class="d-flex flex-wrap align-items-start p-3 border rounded cart-item cart-item-${status.index}">
                                            <!-- Image -->
                                            <img src="${pageContext.request.contextPath}/${item.course.imageUrl}"
                                                 class="cart-img me-3 mb-2 mb-md-0"
                                                    ...
                                                    <c:choose>
                                                        <c:when test="${not empty item.course.categories}">
                                                            <c:forEach var="category" items="${item.course.categories}">
                                                                <span class="badge bg-primary text-wrap">${category.name}</span>
                                                            </c:forEach>
                                                        </c:when>
                                                        <c:otherwise>
                                                            <span class="badge bg-secondary text-wrap">Uncategorized</span>
                                                        </c:otherwise>
                                                    </c:choose>

                                                    <span class="badge bg-secondary text-wrap">${item.course.level}</span>
                                                    <span class="text-muted d-inline-flex align-items-center text-wrap">
                                                        <i class="fas fa-clock me-1"></i> ${item.course.duration}
                                                    </span>
                                                </div>
                                            </div>

                                            <!-- Price -->
                                            <div class="text-md-end text-start mt-2 mt-md-0 order-3 order-md-0 ms-md-auto" style="min-width: 120px;">
                                                <h5 class="mb-0 text-primary">
