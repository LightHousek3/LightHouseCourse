                            ...
                            <div class="card mb-4 shadow-sm">
                                            ...
                                            <div class="card-body">
                                                <div class="row align-items-center">
                                                    <div class="col-md-2 col-4 mb-2 mb-md-0">
                                                        <img src="${pageContext.request.contextPath}/${item.course.imageUrl}" class="cart-img" alt="${item.course.name}">
                                                    </div>
                                                    ...
                                                    <div class="col-md-2 col-6 text-end">
                                                        <a href="${pageContext.request.contextPath}/cart/remove?id=${item.course.courseID}" class="btn btn-outline-danger btn-sm">
                                ...
                                <div class="card-footer bg-white">
                                    <div class="d-flex justify-content-between">
                                        <a href="${pageContext.request.contextPath}/courses" class="btn btn-outline-primary">
                                            <i class="fas fa-arrow-left me-2"></i> Continue Shopping
                                        </a>
                                        <a href="${pageContext.request.contextPath}/cart/clear" class="btn btn-outline-danger">
                            ...
                            <div class="card cart-summary">
                                <div class="card-body">
                                    ...
                                    <div class="d-flex justify-content-between mb-3">
                                        ...
                                        <span class="price-vnd">
                                            <fmt:formatNumber value="${sessionScope.cart.totalPrice}" pattern="#,##0"/>đ
                                        </span>
                                    ...
                                    <div class="d-grid gap-2">
                                        <a href="${pageContext.request.contextPath}/order/checkout" class="btn btn-primary btn-lg">
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <p class="text-muted small mb-0">
                                            <i class="fas fa-infinity me-2"></i> Lifetime access to course content
                                        </p>
                                    </div>
                                </div>
                            </div>
