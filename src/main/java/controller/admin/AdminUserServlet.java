...
public class AdminUserServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if (pathInfo.startsWith("/details/")) {
            ...
            try {
                ...
                request.getRequestDispatcher("/WEB-INF/views/admin/manage-users/user-detail.jsp").forward(request,
                        response);
                return;
        ...
        if (pathInfo.startsWith("/edit/")) {
            ...
            try {
                ...
                if (selectedUser == null) {
                    ...
                    request.getRequestDispatcher("/WEB-INF/views/admin/manage-users/user-update.jsp").forward(request,
                            response);
                    return;
                }
    ...
    private void handleUpdateUser(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (newPassword != null && !newPassword.trim().isEmpty()) {
                userDAO.changePassword(userId, PasswordEncrypt.encryptSHA256(newPassword)); // In reality, you would
