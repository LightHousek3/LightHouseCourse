...
public class VNPayService {
    ...
    public static final String VNP_RETURN_URL = "http://localhost:8080/LightHouseCourse/order/payment"; // URL return
    public static final String VNP_TMN_CODE = "13YG7MEK";
    public static final String VNP_HASH_SECRET = "GG9QD9GR9ZDFFZA9MGSPBNIGJX767QJS";
